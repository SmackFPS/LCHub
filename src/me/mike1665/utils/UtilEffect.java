      ...
      public void run() { Vector vector = new Vector();
        ...
        for (int i = 0; i < this.particlesPerIteration; i++) {
          ...
          UtilVector.rotateVector(vector, this.xRotation, this.yRotation, this.zRotation);
      	  ParticleLib18 res = new ParticleLib18(me.mike1665.particles18.ParticleLib18.ParticleType.FLAME,  0.0D, 1, 0.0D);
      ...
      public void run()
      {
        for (int k = 0; k < this.LineNumber; k++)
        {
          ...
          Math.sin(this.j) * this.radius);
      	  ParticleLib18 res = new ParticleLib18(me.mike1665.particles18.ParticleLib18.ParticleType.HEART,  0.0D, 1, 0.0D);
